...
def test_add_language(get_language_name, get_bible, save_bible, update_language_list):
...
@patch("utilities.add_language.add_language")
def test_main_normalize_language_id_dash(add_language):
...
@patch("utilities.add_language.add_language")
def test_main_normalize_language_id_case(add_language):
